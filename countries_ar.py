# -*- coding: utf-8 -*-
"""Noms des pays en arabe (code ISO 3166-1 alpha-2 -> nom).

Généré à partir des données ICU de Node.js (Intl.DisplayNames), la même source
que le projet précédent (countryCodeToArabicName).
"""
